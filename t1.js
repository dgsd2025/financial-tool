...
/* v2：台账换成《银行资料信息/银行.xlsx》里的真实账户。
   id 前缀同时从 A 换成 B —— 旧的余额是按 A0xx 存的，不换前缀会错挂到新账户上。 */
const T1_ACC_KEY = 'fsc_t1_accounts_v2';
...
/* 账户台账 —— 取自《银行资料信息/银行.xlsx》，37 个法人主体 / 58 个银行账户。
   主体 = 法人公司（资金归属在法人，覆盖倍数按法人算才有意义）。
   简称：银行表 A 列只对应一家公司时直接用该叫法，一个板块盖多家的按公司名推。 */
const T1_PRESET = [
  // 主体简称, 账户名, 类型, 账号
  // 乐时婴童用品
  ['乐时婴童用品', '工行基本户', 'bank', '3602201109100201479'],
  // 星逸文化
  ['星逸文化', '招行一般户', 'bank', '755941553710102'],
  ['星逸文化', '工行基本户', 'bank', '3602201109100129943'],
  // 澳乐电子商务科技
  ['澳乐电子商务科技', '工行一般户 7864', 'bank', '3602201109100127864'],
  ['澳乐电子商务科技', '招行一般户', 'bank', '120914833010605'],
  ['澳乐电子商务科技', '工行美元户', 'bank', '3602201109100180986'],
  ['澳乐电子商务科技', '建行基本户', 'bank', '44050158010700003065'],
  ['澳乐电子商务科技', '中行一般户 1459', 'bank', '738077181459'],
  ['澳乐电子商务科技', '中行一般户 2190', 'bank', '673077492190'],
  ['澳乐电子商务科技', '网商一般户', 'bank', '8888888076590437'],
  ['澳乐电子商务科技', '工行一般户 0445', 'bank', '3602116619100470445'],
  // 橘农农业发展
  ['橘农农业发展', '工行基本户', 'bank', '3602201109100128518'],
  ['橘农农业发展', '中行一般户', 'bank', '718577180149'],
  // 萌立方文化
  ['萌立方文化', '建行基本户', 'bank', '44250100013600000702'],
  // 贝堡儿童用品
  ['贝堡儿童用品', '中行基本户', 'bank', '660066686671'],
  ['贝堡儿童用品', '招行一般户', 'bank', '120915235710703'],
  ['贝堡儿童用品', '建行一般户', 'bank', '44050158010700003333'],
  // 澳乐游玩母婴用品
  ['澳乐游玩母婴用品', '工行基本户', 'bank', '3602201109100146801'],
  ['澳乐游玩母婴用品', '中行一般户', 'bank', '654875145901'],
  ['澳乐游玩母婴用品', '建行一般户', 'bank', '44050158010700003569'],
  // 达观文化
  ['达观文化', '工行基本户', 'bank', '3602201109100150071'],
  // 星逸贸易
  ['星逸贸易', '招行基本户', 'bank', '120907133510202'],
  ['星逸贸易', '建行一般户', 'bank', '44001490053052504657'],
  ['星逸贸易', '网商一般户', 'bank', '8888888038441554'],
  // 堂品玩具
  ['堂品玩具', '浦发一般户', 'bank', '82030154700000406'],
  ['堂品玩具', '工行基本户', 'bank', '3602201109100067975'],
  ['堂品玩具', '网商一般户', 'bank', '8888888201845854'],
  // 奇妙口袋供应链
  ['奇妙口袋供应链', '中行基本户', 'bank', '697766676096'],
  ['奇妙口袋供应链', '建行一般户', 'bank', '44050158010700003334'],
  // 有方新媒体科技
  ['有方新媒体科技', '招行基本户', 'bank', '120914315710601'],
  // 昭妍贸易
  ['昭妍贸易', '农行基本户', 'bank', '44032101040005223'],
  // 源美生物科技
  ['源美生物科技', '招行基本户', 'bank', '120915273010903'],
  // 锐度生物科技
  ['锐度生物科技', '招行基本户', 'bank', '120915330610203'],
  // 艺晟生物科技
  ['艺晟生物科技', '招行基本户', 'bank', '120917408410902'],
  // 荣耀商贸
  ['荣耀商贸', '建行基本户', 'bank', '44050155150200000430'],
  ['荣耀商贸', '农行一般户', 'bank', '44071701040000603'],
  // 不易
  ['不易', '工行基本户', 'bank', '3602201109100436356'],
  // 德逸
  ['德逸', '农商基本户', 'bank', '03101432000000488'],
  // 泰昌
  ['泰昌', '建行基本户', 'bank', '44050158010700004231'],
  // 万视
  ['万视', '招行一般户', 'bank', '120917009510601'],
  ['万视', '中行基本户', 'bank', '680876122444'],
  ['万视', '中行一般户', 'bank', '713378284904'],
  // 贝蜜
  ['贝蜜', '工行账户', 'bank', '3602201109100403932'],
  // 数智
  ['数智', '建行基本户', 'bank', '44050129162500000277'],
  // 云泰
  ['云泰', '建行基本户', 'bank', '44050129162500000270'],
  // AOLE
  ['AOLE', '建行亚洲港元户', 'bank', '846210258411'],
  // 优栖
  ['优栖', '工行账户', 'bank', '3602116609100466418'],
  // 钧恒
  ['钧恒', '农行账户', 'bank', '21-225001040035724'],
  // 弈晟
  ['弈晟', '农行账户', 'bank', '21-225001040035732'],
  // 智租
  ['智租', '工行账户', 'bank', '3602116609100482595'],
  // 优机库
  ['优机库', '工行账户', 'bank', '3602116609100484426'],
  // 瑞眠
  ['瑞眠', '工行账户', 'bank', '3602116609100485851'],
  // 云迪
  ['云迪', '工行基本户', 'bank', '3602003709200608024'],
  // 云湃
  ['云湃', '工行基本户', 'bank', '3602003709200608671'],
  // 云帕
  ['云帕', '工行基本户', 'bank', '3602003709200605167'],
  // 云基
  ['云基', '工行基本户', 'bank', '3602003709200609325'],
  // 闪租
  ['闪租', '工行基本户', 'bank', '3602003709200609449'],
  // 木同
  ['木同', '建行基本户', 'bank', '44050178150100003420'],
];

/* 主体简称 → 法人全称。台账里显示简称，全称用于核对是哪家公司。 */
const T1_ENT_FULL = {
  '乐时婴童用品': '广州乐时婴童用品有限公司',
  '星逸文化': '广州星逸文化有限公司',
  '澳乐电子商务科技': '广州澳乐电子商务科技有限公司',
  '橘农农业发展': '广州市橘农农业发展有限公司',
  '萌立方文化': '深圳萌立方文化有限公司',
  '贝堡儿童用品': '广州贝堡儿童用品有限公司',
  '澳乐游玩母婴用品': '广州澳乐游玩母婴用品有限公司',
  '达观文化': '广州达观文化有限公司',
  '星逸贸易': '广州市星逸贸易有限公司',
  '堂品玩具': '广州堂品玩具有限公司',
  '奇妙口袋供应链': '广州奇妙口袋供应链有限公司',
  '有方新媒体科技': '广州有方新媒体科技有限公司',
  '昭妍贸易': '广州昭妍贸易有限公司',
  '源美生物科技': '广州源美生物科技有限公司',
  '锐度生物科技': '广州锐度生物科技有限公司',
  '艺晟生物科技': '广州艺晟生物科技有限公司',
  ...
  '优机库': '广州优机库贸易有限公司',
  '瑞眠': '广州瑞眠科技有限公司',
  '云迪': '广州云迪物业管理服务合伙企业（有限合伙）',
  '云湃': '广州云湃供应链服务合伙企业（有限合伙）',
  '云帕': '广州云帕供应链管理有限公司',
  '云基': '广州云基电子商务合伙企业（有限合伙）',
  '闪租': '广州闪租数码贸易有限公司',
  '木同': '中山市木同日用品有限公司',
};
...
S['t1-acc'] = () => {
  const rows = T1_ACC.map(a => [
    ...
    `<input class="t1in wide" data-t1acc="${a.id}:ent" value="${H(a.ent)}">`
      + (T1_ENT_FULL[a.ent] ? `<div class="mut" style="font-size:11px">${H(T1_ENT_FULL[a.ent])}</div>` : ''),
  ...
  return head('账户台账', `在管 <b>${T1_ACC.filter(a => a.on).length}</b> / 共 ${T1_ACC.length} 个。改完点保存。`, '工具箱 · T1',
    ...
    + `<div class="note"><b>${T1_PRESET.length} 个账户来自《银行资料信息/银行.xlsx》</b>，${Object.keys(T1_ENT_FULL).length} 个法人主体。
